...
Las actitudes peligrosas llevan a comportamientos peligrosos que incluyen complacencia, indisciplina y sobreconfianza, lo que todo aumenta el riesgo de un accidente de planeador.

### Complacencia

La complacencia puede ocurrir si un piloto siente una falsa sensación de seguridad sobre los alrededores. Esto podría afectar a un piloto de planeador que solo quiere volar y no comprende los peligros y riesgos asociados. La complacencia también afecta a los pilotos de planeador que ya no se sienten obligados a adherirse a las precauciones de seguridad estándar (por ejemplo, "He hecho esto un millón de veces y no necesito consultar una lista de verificación.").

Algunas contramedidas incluyen:

• Reservar suficiente tiempo para prepararse para cada vuelo.

• Examinar peligros y abordar el riesgo asociado de cada vuelo.

• Desafiarse a uno mismo para cumplir un estándar de excelencia en cada vuelo.
...
Los pilotos interesados en más información sobre un enfoque disciplinado a la seguridad de aviación pueden referirse al Manual de Gestión de Riesgo de la FAA (FAA-H-8083-2), que describe técnicas estructuradas que los pilotos pueden usar que incluyen cómo establecer o revisar mínimos personales y cómo conducir un análisis de seguridad disciplinado y exhaustivo antes del vuelo.
...
Todos los pilotos cometen errores, y muchos pilotos pueden tener vacíos en el conocimiento. Las evaluaciones de entrenamiento, exámenes de vuelo (escritos u orales), verificaciones operacionales, críticas y auto-evaluaciones del piloto post-vuelo pueden destacar lo que un piloto puede hacer mejor. Una evaluación honesta y justa puede llevar a la corrección de cualquier deficiencia y reducir el potencial de accidentes.
...
La hipoxia resulta del oxígeno reducido o no suficiente oxígeno. Aunque el tejido celular humano morirá si se le priva de oxígeno por suficiente tiempo, la preocupación principal para los pilotos es la falta de oxígeno al cerebro, que puede reducir la capacidad cognitiva y resultar en errores que amenazan la vida. La hipoxia tiene varios factores causales, incluyendo un suministro insuficiente de oxígeno, transporte inadecuado de oxígeno, o la incapacidad de los tejidos corporales para usar el oxígeno. Las formas de hipoxia se basan en sus causas:

#### Hipoxia Hipóxica

La hipoxia hipóxica resulta del oxígeno insuficiente disponible para el cuerpo en general. La reducción en la presión parcial de oxígeno a gran altitud puede hacer que un piloto experimente este tipo de hipoxia. A medida que una aeronave no presurizada asciende durante el vuelo, el porcentaje de oxígeno atmosférico permanece constante, pero un número reducido de moléculas de oxígeno entran a los pulmones y pasan entre las membranas dentro del sistema respiratorio.

#### Hipoxia Hiperémica

La hipoxia hiperémica ocurre cuando la sangre no puede captar suficiente oxígeno. Las causas de esta forma de hipoxia incluyen volumen sanguíneo reducido por sangrado severo o ciertas enfermedades de la sangre, como anemia. El envenenamiento por monóxido de carbono causa este tipo de hipoxia. La hemoglobina, la molécula de sangre que transporta oxígeno, se vuelve químicamente incapaz de unir moléculas de oxígeno si se expone al monóxido de carbono. La hipoxia hiperémica también puede ocurrir después de una donación de sangre. Mientras que el volumen sanguíneo se normaliza rápidamente después de una donación, restaurar la hemoglobina perdida puede tomar varias semanas. Aunque los efectos de la pérdida de sangre parecen leves al nivel del suelo, la donación de sangre puede crear un riesgo de vuelo durante el período de recuperación.
...
Cuando ocurre la hipoxia histotóxica, el cuerpo transporta suficiente oxígeno a las células, pero no pueden hacer uso de él. Este deterioro de la respiración a nivel celular puede resultar del consumo de alcohol, exposición a ciertas drogas o narcóticos, o exposición a venenos.
...
A medida que empeora la hipoxia, el campo de visión del piloto comienza a estrecharse, y la interpretación de instrumentos puede volverse difícil. Incluso con todos estos síntomas, los efectos de la hipoxia pueden dar a un piloto una falsa sensación de seguridad.
...
La presión interna de la cavidad del oído medio cambia más lentamente que la presión fuera del oído. Una diferencia de presión puede desarrollarse durante un ascenso o descenso, lo que puede resultar en pérdida auditiva temporal, malestar, dolor y distracción de las tareas de vuelo.

Cuando un planeador asciende, la presión del aire del oído medio puede exceder la presión del aire en el conducto auditivo externo, haciendo que el tímpano se abombe hacia afuera. Esta condición usualmente se resuelve por sí sola, y el piloto puede notar un sonido de estallido a medida que la presión se iguala y la sensibilidad auditiva vuelve a la normalidad. Durante un descenso, la presión del aire en el conducto auditivo externo puede aumentar por encima de la de la cavidad del oído medio, lo que hace que el tímpano se abombe hacia adentro. La condición durante un descenso parece más dolorosa y desagradable para la mayoría de las personas. El resfriado nasal o un resfrío pueden hacer que la ecualización de presión sea difícil o imposible. Masticar chicle, chupar dulces duros o tragar pueden ayudar a la ecualización de presión durante un descenso.

El malestar durante un descenso termina cuando suficiente aire fluye hacia el oído medio a través de la trompa de Eustaquio. Sin embargo, la presión más baja en el oído medio tiende a constreñir las paredes de la trompa de Eustaquio y prevenir el flujo de aire al oído medio. Un piloto puede intentar la maniobra de Valsalva para corregir esta situación. El piloto debe pellizcar las fosas nasales, cerrar la boca y labios, y soplar lentamente y suavemente en la boca y nariz para forzar aire hacia arriba por la trompa de Eustaquio hacia el oído medio.
...
El golpe de calor resulta cuando el cuerpo no puede controlar la temperatura excesivamente alta. El inicio de esta condición puede imitar la deshidratación, pero también puede llevar a colapso. Para prevenir estos síntomas, el piloto debe llevar un suministro amplio de agua y usarlo a intervalos frecuentes en cualquier vuelo largo, incluso si no tiene sed. Usar ropa de colores claros y porosa y un sombrero proporciona protección del sol. Ventilar la cabina también ayuda a remover el exceso de calor.
...
Los pilotos pueden usar un paracaídas para emergencias. Un empacador de paracaídas certificado y con calificación apropiada debe reempacar un paracaídas de nylon dentro de los 180 días precedentes. La información de fecha de empaque usualmente se encuentra en una tarjeta contenida en un pequeño bolsillo en el cuerpo del paracaídas. Refiérase al 14 CFR, parte 91, sección 91.307 para más información.

### Oxígeno Suplementario

Los vuelos de vela de gran altitud requieren el uso de oxígeno suplementario. En algunas partes del país, la vela ocurre rutinariamente hasta una base de nubes de 16,000 a 18,000 pies en térmicas. El vuelo usando ondas montañosas puede llevar a vuelo a altitudes de más de 30,000 pies en Estados Unidos.

La respiración suministra oxígeno a la sangre y remueve dióxido de carbono. En cada respiración a 18,000 pies, el piloto respira solo la mitad de oxígeno que a nivel del mar. La reacción automática del piloto sin un suministro adecuado de oxígeno involucraría respirar dos veces más rápido. Esta hiperventilación, o respiración excesiva, resultaría en eliminar demasiado dióxido de carbono de la sangre.

El 14 CFR, parte 91, sección 91.211, dicta los requisitos de tiempo y altitud para el uso de oxígeno suplementario. Antes del uso de oxígeno suplementario, el sistema debe revisarse por disponibilidad de oxígeno y flujo. El piloto puede usar la lista de verificación PRICE:
...
• E = Botella de emergencia de escape

#### Sistemas de Oxígeno de Aviación

Un sistema de oxígeno de aviación portátil entrega oxígeno usando componentes ligeros y compactos. Entrega una cantidad calibrada de oxígeno basada en investigación extensiva en fisiología de vuelo humano. Antes de comprar cualquier tipo de sistema de oxígeno, los pilotos deben considerar el tipo de vuelo que hacen. Dos tipos comunes diferentes de sistemas usados hoy incluyen el Sistema de Flujo Continuo y el Sistema de Demanda de Pulso Electrónico (EDS). Los pilotos solo deben usar oxígeno de aviador suministrado en una botella verde con estos sistemas y nunca usar oxígeno médico. El oxígeno médico puede contener agua y podría dejar inoperable un sistema de oxígeno del piloto.
...
Este Manual se enfoca en el individuo y no en los sistemas de gestión de seguridad (SMS). El SMS aborda la gestión de riesgo desde una perspectiva organizacional como una actividad continua. Las personas interesadas pueden obtener información sobre SMS del Manual de Gestión de Riesgo (FAA-H-8083-2).

### Toma de Decisiones Aeronáuticas (ADM)

Un piloto toma numerosas decisiones aeronáuticas involucrando gestión de riesgo antes de que comience un vuelo. Un medio estructurado involucra usar una Herramienta de Evaluación de Riesgo de Vuelo o FRAT. Los pilotos pueden consultar el Manual de Gestión de Riesgo de la FAA (FAA-H-8083-2) para una muestra de FRAT y pueden usar una para mejorar la seguridad del vuelo.
...
• Circunstancia: Mis baterías de aeronave o radio están bajas. Decisión: Solo estoy planeando un vuelo corto, así que iré.
