...
Según la Tercera Ley del Movimiento de Newton, para cada acción hay una reacción igual y opuesta. A medida que el aire se desvía hacia abajo debido a la interacción con el ala, el ala experimenta una reacción hacia arriba (sustentadora).

#### Principio de Bernoulli

El Principio de Bernoulli establece que a medida que aumenta la velocidad de un fluido en movimiento (líquido o gas), la presión dentro del fluido disminuye. Este principio explica lo que ocurre cuando el aire se mueve más rápido para pasar sobre la parte superior de un ala posicionada en un ángulo respecto al viento relativo, es decir, el viento resultante del movimiento hacia adelante del planeador. El aumento en la velocidad del aire al viajar sobre la parte superior del ala produce una caída en la presión contra el ala, y la mayor presión del aire debajo del ala resulta en una fuerza de sustentación neta.
...
Operar dentro de una envergadura de ala por encima del suelo modifica el patrón de flujo de aire tridimensional alrededor del planeador. Este efecto suelo disminuye el flujo descendente, reduce el tamaño y efecto de los vórtices de punta de ala, reduce la resistencia inducida y resulta en un vuelo más eficiente. Este efecto permite que el planeador vuele a una velocidad más baja durante el despegue y reduce la tasa de descenso de un planeador al aterrizar.

### Peso

El peso resulta de la fuerza de gravedad actuando sobre la masa del planeador. Los componentes verticales tanto de la sustentación como de la resistencia actúan en oposición al vector de peso, que actúa verticalmente hacia abajo a través del centro de gravedad.

### Empuje

Los planeadores sin motor utilizan una fuente externa, como un avión de remolque, un torno o un vehículo, para lanzarse. Una vez liberados, estos planeadores mantienen el movimiento hacia adelante a partir de la conversión de energía potencial a energía cinética. Un planeador desciende a través del aire circundante para hacer esta conversión. Los planeadores con motor tienen motores, que pueden proporcionar empuje para el lanzamiento o para sostener el vuelo.
...
Un punto específico aparece en la Figura 3-7 arriba. El punto mostrado, (L/DMAX), corresponde a una velocidad donde la capacidad total de sustentación del planeador, cuando se compara con la resistencia total alcanza un valor máximo. En aire en calma, esta velocidad produce la distancia máxima de planeo y la relación de planeo publicada para un planeador. La relación de planeo da la distancia que el planeador puede viajar durante un descenso dado en altitud. Por ejemplo, una relación de planeo de 50:1 significa que un planeador podría viajar 50 pies hacia adelante mientras pierde un pie de altitud.
...
Los dispositivos de punta de ala, o winglets, también mejoran la eficiencia del planeador al alterar el flujo de aire cerca de las puntas del ala y reducir la resistencia inducida.

### Torsión Geométrica (Washout)

La raíz del ala se refiere a la porción del ala más cercana al fuselaje. La torsión geométrica (washout) se refiere a una ligera torsión del ala entre la raíz del ala y la punta del ala, lo que hace que la raíz del ala tenga un ángulo de ataque (AOA) mayor que la punta del ala. Si el AOA se vuelve excesivo, el flujo de aire se separará en la raíz del ala antes de que ocurra la separación en la punta del ala. Este diseño de ala proporciona advertencia de cualquier pérdida inminente o separación general del aire del ala y permite el control continuo de los alerones al inicio de una pérdida.
...
Debido a la flexibilidad del diseño del ala de un planeador, el ala puede oscilar rápidamente o vibrar (flutter) a altas velocidades del aire. Además, la holgura en las superficies de control también puede resultar en vibración de las superficies de control de vuelo cerca de la velocidad máxima. El balanceo inadecuado de las superficies de control también puede causar vibración. Dado que la vibración prolongada puede causar falla estructural, el piloto debe reducir la velocidad del aire suficientemente para detener cualquier vibración.

## Oscilación Inducida por el Piloto (PIO)

Las oscilaciones inducidas por el piloto (PIOs) pueden ocurrir cuando el piloto aplica presión excesiva en los controles que causa un sobrepaso de la actitud de vuelo deseada. Si el piloto mueve repetidamente los controles de un lado a otro usando presión excesiva, el planeador oscila continuamente más allá de la actitud deseada. Las oscilaciones pueden aumentar en amplitud y pueden causar pérdida de control. Aunque las PIOs ocurren más probablemente como oscilaciones de cabeceo, también pueden ocurrir oscilaciones de rolido y guiñada inducidas.

Aunque las PIOs pueden ocurrir en cualquier momento, a menudo surgen durante el entrenamiento primario. Los pilotos experimentados también pueden inducir PIOs cuando vuelan un planeador de marca y modelo desconocidos. Por esa razón y antes de volar un planeador desconocido, todos los pilotos deben revisar y comprender las características de vuelo de ese planeador.

Si se encuentran con PIOs, el piloto debe recordar que los cambios en la actitud de vuelo toman tiempo. El piloto debe comenzar a aliviar la presión de los controles de vuelo a medida que el planeador comienza a responder en la dirección deseada. A medida que el planeador se acerca a la actitud deseada, el piloto centra el control de vuelo apropiado para que no ocurra un sobrepaso.

Durante los primeros momentos de la carrera de despegue, a medida que el flujo de aire comienza a impactar las superficies de control, se requiere un desplazamiento considerable de los controles de vuelo para afectar la trayectoria de vuelo del planeador. El piloto también experimenta un mayor tiempo de retardo de control debido a la efectividad reducida del control a baja velocidad. A medida que el planeador acelera, la respuesta aerodinámica mejora, el tiempo de retardo disminuye y las PIOs se vuelven menos probables.
...
Cualquier fuerza aplicada a un planeador para desviar su vuelo de una línea recta produce un esfuerzo en su estructura; el factor de carga describe esta fuerza. El factor de carga es la relación entre la carga total de aire actuando sobre el planeador y el peso del planeador. El factor de carga puede ser positivo o negativo y depende de la trayectoria de vuelo actual. Las unidades de factor de carga a menudo usan "G," una fuerza gravitacional equivalente. Un factor de carga de uno, o 1 G, representa condiciones en las que la sustentación es igual al peso. Un planeador en vuelo con un factor de carga de uno no significa necesariamente que el planeador está en vuelo recto y nivelado, sino más bien que la sustentación total es igual a la del vuelo recto y nivelado no acelerado.

Al someter a un planeador a Gs adicionales en una recuperación de picado, cualquier persona en el planeador siente una sensación de presionar contra el asiento con una fuerza igual al número de Gs multiplicado por el peso de la persona. Además, las extremidades de la persona requieren fuerza muscular adicional para resistir la fuerza descendente. Los Gs añadidos pueden afectar el flujo sanguíneo al cerebro, afectar la capacidad cognitiva y causar desorientación.

El factor de carga aumenta rápidamente a medida que el ángulo de inclinación aumenta durante un giro cuando el piloto aumenta la sustentación para evitar un cambio en la velocidad vertical. Desde una perspectiva aerodinámica, los factores de carga preocupan al piloto por dos razones distintas:

1. Por debajo de cierta velocidad del aire, ocurre una pérdida antes de que el piloto pueda crear una sobrecarga peligrosa en la estructura del planeador.
...
La tasa de giro se refiere a la cantidad de tiempo que le toma a un planeador girar un número especificado de grados. Si se vuela a la misma velocidad del aire y ángulo de inclinación, cada planeador gira a la misma tasa. Si la velocidad del aire aumenta mientras el ángulo de inclinación permanece igual, la tasa de giro disminuye. Por el contrario, una velocidad del aire constante junto con un ángulo de inclinación aumentado resulta en una tasa de giro aumentada.
...
Al entrar en un giro, el alerón bajado en el ala exterior produce más sustentación para ese ala. Dado que la resistencia inducida es un subproducto de la sustentación, el ala exterior también experimenta más resistencia que el ala interior. Esto causa una guiñada adversa, una tendencia de guiñada hacia el exterior del giro. El uso apropiado del timón corrige cualquier guiñada adversa causada por la resistencia del alerón. Debido a que las alas de los planeadores proporcionan un brazo de palanca largo para la guiñada adversa, el piloto puede necesitar usar presión sustancial en el timón durante un giro coordinado. La cantidad de guiñada adversa puede sorprender a un piloto que hace la transición desde un avión, y la cantidad de guiñada adversa será mucho mayor que la experimentada en un avión típico.

Aunque el vuelo descoordinado disminuye el rendimiento, los pilotos pueden usar diferentes técnicas de resbalón para empinizar el ángulo de descenso o para contrarrestar un viento cruzado durante el aterrizaje.

Debido a la ubicación del tubo pitot y las ventanas estáticas, los indicadores de velocidad del aire en algunos planeadores pueden tener un error considerable cuando el piloto coloca el planeador en un resbalón. El piloto debe reconocer este error y saber cómo realizar resbalones basándose en indicaciones secundarias como la actitud del planeador, el sonido del flujo de aire y la sensación de los controles de vuelo.

Un piloto normalmente coordina las entradas de timón y alerón durante un giro. Usar muy poco timón, o si el timón se aplica demasiado tarde, resulta en un resbalón. Demasiado timón, o timón aplicado antes que el alerón, resulta en un derrape. Tanto los derrapes como los resbalones exponen un lado del fuselaje al viento relativo, creando resistencia parásita adicional.
...
Nota: Los resbalones hacia adelante con flaps del ala extendidos no deben ocurrir si las instrucciones de operación del fabricante prohíben tal operación.

#### Resbalón Lateral (Sideslip)

Durante aterrizajes con viento cruzado, un resbalón lateral puede contrarrestar la deriva del viento y permite que el planeador toque tierra con su eje longitudinal paralelo a la dirección del movimiento. El piloto usa presión en el timón para mantener el eje longitudinal del planeador paralelo a la trayectoria deseada sobre el suelo, pero la trayectoria sobre el suelo puede cambiar dependiendo de la cantidad de inclinación. Para realizar un resbalón lateral, el piloto baja el ala de barlovento y aplica simultáneamente suficiente timón opuesto para mantener la alineación de la nariz.
